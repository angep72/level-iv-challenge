...
exports.validateMongoId = exports.validateBooking = exports.validateEvent = exports.validateLogin = exports.validateRegister = exports.handleValidationErrors = void 0;
...
exports.validateEvent = [
    ...
    (0, express_validator_1.body)('maxCapacity').isInt({ min: 1 }),
    (0, express_validator_1.body)('price').isFloat({ min: 0 }),
    exports.handleValidationErrors
];
exports.validateBooking = [
    (0, express_validator_1.body)('eventId').isMongoId(),
    exports.handleValidationErrors
];
