...
export declare const validateMongoIdParam: (((req: Request, res: Response, next: NextFunction) => void | Response<any, Record<string, any>>) | import("express-validator").ValidationChain)[];
